...
plot(w3$DateTimeConvert,w3$Global_active_power,main="Plot 4", ylab="Global Active Power (Kilowatts)",xlab="",type="l")
plot(w3$DateTimeConvert,w3$Voltage,main="", ylab="Voltage",xlab="",type="l")
...
plot(w3$DateTimeConvert,w3$Global_reactive_power,main="", ylab="Global Reactive Power ",xlab="",type="l")
